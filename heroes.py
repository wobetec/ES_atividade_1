...
class HumanoLadino(Hero):
    def __init__(self, nome):
        super().__init__(nome, "Humano", "Ladino", forca=5, inteligencia=10, destreza=7)
...
class ElfoLadino(Hero):
    def __init__(self, nome):
        super().__init__(nome, "Elfo", "Ladino", forca=4, inteligencia=12, destreza=9)
...
class OrcMago(Hero):
    def __init__(self, nome):
        super().__init__(nome, "Orc", "Mago", forca=12, inteligencia=3, destreza=6)
